...
public class PointView {
	...
	public int wannaUsePoint( int amount ) {
		while(true) {
			...
			//포인트가 없으면 return 0
			if ( point == 0 ) { System.out.println("포인트가 없습니다."); return 0;	}
			//포인트 사용안내
			...
			if ( point > 100 ) {
				...
				if ( wannaPoint%100 != 0) { System.out.println("100원 단위만 사용가능합니다."); continue;	}
